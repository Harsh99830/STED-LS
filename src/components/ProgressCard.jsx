...
export default function ProgressCard({ stats }) {
  return (
    <div className="absolute top-20 right-4 sm:right-6 md:right-8 w-72 p-5 rounded-2xl z-50 shadow-2xl animate-slide-in 
      bg-gradient-to-br from-purple-200/60 via-pink-100/50 to-yellow-100/60 
      backdrop-blur-md border border-white/20 transition-transform duration-700 ease-out font-mono">
