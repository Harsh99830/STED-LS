...
export default function TaskPointsBox({ points }) {
  ...
  return (
    <div className="bg-gradient-to-br from-[#fefcea] via-[#e7f0fd] to-[#f5faff] backdrop-blur-md mt-7 ml-18 shadow-2xl border border-[#d1d5db] rounded-3xl p-6 max-w-150 h-80 animate-fade-in transition-all duration-500 ease-in-out transform hover:scale-105 hover:shadow-[0_10px_20px_rgba(0,0,0,0.2)] hover:border-[#60a5fa]">
