                ...
                <div className="w-full relative px-4 lg:px-8 pb-12">
                    ...
                    <div className="mt-8">
                        <div className="flex items-center justify-between">
                            <div>
                                <h1 className="text-3xl font-bold text-slate-800">Decision Making Learning Path</h1>
                                <p className="text-slate-600 mt-2">Develop critical thinking and effective decision-making skills</p>
                            </div>
                            <Link
                                to="/task"
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
                        ...
                        >
                            ...
                            <div className="bg-purple-50 rounded-lg p-4 mb-4">
                                <h3 className="font-medium text-purple-900">Decision Analysis Case Study</h3>
                                <p className="text-purple-700 mt-2">Analyze a business case and make strategic decisions</p>
                            ...
                            <div className="space-y-4">
                                <div>
                                    <div className="flex justify-between mb-2">
                                        <span className="text-sm text-slate-600">Decision Analysis</span>
                                        <span className="text-sm font-medium text-slate-800">{userData.decisionSkill || 45}%</span>
                                    </div>
                                    <div className="w-full bg-slate-200 rounded-full h-2">
                                        <div className="bg-purple-600 h-2 rounded-full" style={{ width: `${userData.decisionSkill || 45}%` }}></div>
                                    </div>
                                </div>
                                <div>
                                    <div className="flex justify-between mb-2">
                                        <span className="text-sm text-slate-600">Problem Solving</span>
                                        <span className="text-sm font-medium text-slate-800">{userData.problemSkill || 30}%</span>
                                    </div>
                                    <div className="w-full bg-slate-200 rounded-full h-2">
                                        <div className="bg-green-600 h-2 rounded-full" style={{ width: `${userData.problemSkill || 30}%` }}></div>
                                    </div>
                                </div>
                                <div>
                                    <div className="flex justify-between mb-2">
                                        <span className="text-sm text-slate-600">Critical Thinking</span>
                                        <span className="text-sm font-medium text-slate-800">{userData.criticalSkill || 20}%</span>
                                    </div>
                                    <div className="w-full bg-slate-200 rounded-full h-2">
                                        <div className="bg-blue-600 h-2 rounded-full" style={{ width: `${userData.criticalSkill || 20}%` }}></div>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        <h3 className="font-medium text-slate-800">Decision Making Frameworks</h3>
                                        <p className="text-slate-600 text-sm mt-1">Learn structured approaches to making decisions</p>
                                    </div>
                                </div>
                                <div className="flex items-start">
                                    <div className="bg-purple-50 p-2 rounded-full mr-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-600 text-sm mt-1">Tools and techniques for risk assessment</p>
                                    </div>
                                </div>
                                <div className="flex items-start">
                                    <div className="bg-purple-50 p-2 rounded-full mr-3">
                                    ...
                                    <div>
                                        <h3 className="font-medium text-slate-800">Problem Solving Techniques</h3>
                                        <p className="text-slate-600 text-sm mt-1">Methods for effective problem solving</p>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
