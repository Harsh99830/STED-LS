                ...
                <div className="w-full relative px-4 lg:px-8 pb-12">
                    ...
                    <div className="mt-8">
                        <div className="flex items-center justify-between">
                            <div>
                                <h1 className="text-3xl font-bold text-slate-800">Web Development Learning Path</h1>
                                <p className="text-slate-600 mt-2">Master HTML, CSS, JavaScript, and React.js</p>
                            </div>
                            <Link
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
                        ...
                        >
                            ...
                            <div className="bg-blue-50 rounded-lg p-4 mb-4">
                                <h3 className="font-medium text-blue-900">Responsive Portfolio Website</h3>
                                <p className="text-blue-700 mt-2">Build a modern portfolio website using HTML, CSS, and JavaScript</p>
                                <div className="flex items-center mt-4">
                                    <span className="text-sm text-blue-600">+150 XP</span>
                                    <span className="mx-2">•</span>
                                    <span className="text-sm text-blue-600">60 minutes</span>
                                </div>
                            </div>
                            <Link
                                to="/web-devlopment/task"
                            ...
                            <div className="space-y-4">
                                <div>
                                    <div className="flex justify-between items-center mb-2">
                                        <span className="text-sm text-slate-600">HTML & CSS</span>
                                        <span className="text-sm text-blue-600">{userData.htmlSkill || 0}%</span>
                                    </div>
                                    <div className="h-2 bg-slate-100 rounded-full">
                                        <div className="h-2 bg-blue-600 rounded-full" style={{ width: `${userData.htmlSkill || 0}%` }}></div>
                                    </div>
                                </div>
                                <div>
                                    <div className="flex justify-between items-center mb-2">
                                        <span className="text-sm text-slate-600">JavaScript</span>
                                        <span className="text-sm text-blue-600">{userData.jsSkill || 0}%</span>
                                    </div>
                                    <div className="h-2 bg-slate-100 rounded-full">
                                        <div className="h-2 bg-blue-600 rounded-full" style={{ width: `${userData.jsSkill || 0}%` }}></div>
                                    </div>
                                </div>
                                <div>
                                    <div className="flex justify-between items-center mb-2">
                                        <span className="text-sm text-slate-600">React.js</span>
                                        <span className="text-sm text-blue-600">{userData.reactSkill || 0}%</span>
                                    </div>
                                    <div className="h-2 bg-slate-100 rounded-full">
                                        <div className="h-2 bg-blue-600 rounded-full" style={{ width: `${userData.reactSkill || 0}%` }}></div>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
