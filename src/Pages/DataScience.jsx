                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
                        ...
                        >
                            ...
                            <div className="bg-purple-50 rounded-lg p-4 mb-4">
                                <h3 className="font-medium text-purple-900">Data Analysis Challenge</h3>
                                <p className="text-purple-700 mt-2">Analyze a real-world dataset using Python and Pandas</p>
                                <div className="flex items-center mt-4">
                                    <span className="text-sm text-purple-600">+100 XP</span>
                                    <span className="mx-2">•</span>
                                    <span className="text-sm text-purple-600">45 minutes</span>
                                </div>
                            </div>
                            <Link
                                to="/task"
