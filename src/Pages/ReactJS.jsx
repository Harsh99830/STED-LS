        ...
        const projectsData = Object.values(projectsSnap.val())
          .filter(project => {
            ...
            return Array.isArray(skills) 
              ? skills.some(s => s.toLowerCase() === 'react.js')
              : skills.toLowerCase() === 'react.js';
          });
        
        const totalSP = projectsData.length * 10; // 10 SP per React.js project
        ...
        <div className="w-full relative px-4 lg:px-8 pb-12">
          {/* Header Section */}
              ...
              <div className="text-left mt-6">
                <h1 className="text-3xl font-bold text-slate-800">React JS</h1>
            </div>
